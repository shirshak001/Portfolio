...
const createParticleElement = (x, y, color = DEFAULT_GLOW_COLOR) => {
  ...
  el.style.cssText = `
    positiconst BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="bento-section select-none relative overflow-visible"
              ...
              return (
                ...
                >
                  ...
                  <div className="card__content flex flex-col relative text-white">
                    <h3
                      className={`card__title font-normal text-lg m-0 mb-1 ${
